...
```{r sim_data_x_1, fig.dim = c(6, 6), fig.cap = "Simulated track of an animal wandering around its habitat, starting at the diamond and ending at the square."}
## load MASS library
library(MASS)
...
```{r sim_data_y_1, fig.dim = c(6, 6), fig.cap = "Simulated true track of an animal wandering around its habitat (blue) and the observed locations (gray). Each track starts at the diamond and ends at the square."}
