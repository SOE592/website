...
```{r tslab-plotTrendTSb, eval = TRUE, echo = FALSE, fig.cap = '(ref:tslab-plotTrendTSb)'}
## estimate of trend
co2_trend <- stats::filter(co2, filter = fltr, method = "convo", sides = 2)
...
```{r tslab-plotSeasTSa, eval = FALSE, echo = TRUE}
...
```{r tslab-plotSeasTSb, eval = TRUE, echo = FALSE, fig.cap = '(ref:tslab-plotSeasTSb)'}
## set the margins & text size
par(mai = c(1.2, 1, 0.3, 1), omi = c(0, 0, 0, 0), cex = 1)
...
```{r tslab-plotdataPar3, eval = FALSE, echo = TRUE}
## plot the monthly seasonal effects
...
```{r tslab-plotSeasMean, eval = TRUE, echo = FALSE, fig.cap = '(ref:tslab-plotSeasMean)'}
## set the margins & text size
par(mai = c(1.2, 1, 0.3, 1), omi = c(0, 0, 0, 0), cex = 1)
## plot the ts
plot.ts(mm, ylab = "Seasonal effect", xlab = "Month", cex = 1)
...
```{r tslab-plotdataPar4, eval = FALSE, echo = TRUE}
...
```{r tslab-plotDecompA, eval = FALSE, echo = TRUE}
## plot the obs ts, trend & seasonal effect
...
```{r tslab-plotCO2diff2Echo, eval = FALSE, echo = TRUE}
...
```{r tslab-plotCO2diff2, eval = TRUE, echo = FALSE, fig.cap = '(ref:tslab-plotCO2diff2)'}
## set the margins & text size
...
```{r tslab-plotCO2diff12, eval = TRUE, echo = FALSE, fig.cap = '(ref:tslab-plotCO2diff12)'}
## set the margins & text size
par(mar = c(4, 4.5, 1, 1), oma = c(0, 0, 0, 0), cex = 1)
...
```{r tslab-plotACFb, eval = TRUE, echo = FALSE, fig.cap = '(ref:tslab-plotACFb)'}
## set the margins & text size
par(mai = c(1.2, 1, 0.3, 1), omi = c(0, 0, 0, 0), cex = 1)
## correlogram of the CO2 data
acf(co2, lag.max = 36)
...
```{r tslab-plotbetterACF, eval = TRUE, echo = FALSE, fig.cap = '(ref:tslab-plotbetterACF)'}
## set the margins & text size
par(mai = c(1.2, 1, 0.3, 1), omi = c(0, 0, 0, 0), cex = 1)
...
```{r tslab-plotLinearACF, eval = TRUE, echo = FALSE, fig.cap = '(ref:tslab-plotLinearACF)'}
## set the margins & text size
...
```{r tslab-plotSineACF, eval = TRUE, echo = FALSE, fig.cap = '(ref:tslab-plotSineACF)'}
## set the margins & text size
par(mfrow = c(1, 2), mai = c(1.2, 1, 0.3, 1), omi = c(0, 0, 0, 0), cex = 1)
...
```{r tslab-plotSiLiACF, eval = TRUE, echo = FALSE, fig.cap = '(ref:tslab-plotSiLiACF)'}
## set the margins & text size
par(mfrow = c(1, 2), mai = c(1.2, 1, 0.3, 1), omi = c(0, 0, 0, 0), cex = 1)
...
```{r tslab-plotPACFb, eval = TRUE, echo = FALSE, fig.cap = '(ref:tslab-plotPACFb)'}
## set the margins & text size
par(mai = c(1.2, 1, 0.3, 1), omi = c(0, 0, 0, 0), cex = 1)
...
```{r tslab-plotCCFb, eval = TRUE, echo = FALSE, fig.cap = '(ref:tslab-plotCCFb)'}
## set the margins & text size
par(mai = c(1.2, 1, 0.3, 1), omi = c(0, 0, 0, 0), cex = 1)
