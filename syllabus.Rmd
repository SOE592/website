...
This is an intensive short course that will run from 8:30-5:00 on January 3-5. The daily schedule is as follows:

```{r daily_schedule, echo=FALSE}
## data frame with dates & topics
sch_txt <- data.frame(
  Time = c("8:30&nbsp;-&nbsp;10:00", "10:00&nbsp;-&nbsp;10:15",
           "10:15&nbsp;-&nbsp;11:45", "11:45&nbsp;-&nbsp;12:30",
           "12:30&nbsp;-&nbsp;2:00", "2:00&nbsp;-&nbsp;3:30",
           "3:30&nbsp;-&nbsp;3:45", "3:45&nbsp;-&nbsp;5:00"),
  Activity = c("Session 1", "Break", "Session 2", "Lunch",
               "Session 3", "Session 4", "Break", "Session 5")
)
